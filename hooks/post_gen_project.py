...
subprocess.run([sys.executable, "-m", "pip", "install", "-r", os.path.join(local_path, 'requirements.txt')])
subprocess.run([sys.executable, "-m", "pip", "install", "-r", 'requirements.txt'], cwd=os.path.join(local_path, 'src', 'application'))
